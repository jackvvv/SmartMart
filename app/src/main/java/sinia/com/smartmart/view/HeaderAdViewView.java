...
import sinia.com.smartmart.adapter.HeaderAdAdapter;
import sinia.com.smartmart.utils.DensityUtil;
import sinia.com.smartmart.utils.ImageManager;
...
public class HeaderAdViewView extends HeaderViewInterface<List<String>> {
    ...
    private void addIndicatorImageViews(int size) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(DensityUtil.dip2px(mContext, 5), DensityUtil
                    .dip2px(mContext, 5));
            if (i != 0) {
