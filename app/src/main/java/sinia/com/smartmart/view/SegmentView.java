...
public class SegmentView extends LinearLayout {
    ...
    private void init() {
//      this.setLayoutParams(new LinearLayout.LayoutParams(dp2Px(getContext(), 60), LinearLayout.LayoutParams
// .WRAP_CONTENT));
        ...
        XmlPullParser xrp = getResources().getXml(R.drawable.text_color_select2);
        try {
        ...
        textView1.setBackgroundResource(R.drawable.segment_left_selector);
        textView2.setBackgroundResource(R.drawable.segment_right_selector);
